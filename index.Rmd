...
## Introduction
Our group domain of interest is mental health since we are college students and 
we care about how mental health problems can cause results such as suicide or 
other unexpected results in the world. From the three datasets we find, we choose
the dataset related to the suicide rate from 1985 to 2015 since it can be used 
to compare the suicide numbers between different age groups and sexes and even 
...
to know which country has the highest mental health problems behind the problem 
of suicide. 
