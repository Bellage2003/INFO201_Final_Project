...
intro_page <- tabPanel(
  ...
  p("Our group has been working with a data set that involved mental health in a variety of countries. We have decided to specifically focus on the comparison between the U.S. and Japan.
     In the first chart, the information being shown is a comparison of suicide rates in men ages 25-34 in the U.S. and Japan. The shiny widget that will be used to portray this information is radio buttons and select box.
     In the second chart, the information being shown is a comparison of suicide numbers between different age groups. The information will be shown through a stacked bar chart and the widget being used for this is select box, and check box.
     Lastly, the third chart will show a comparison of number of suicides between males and females in the U.S. and Japan. The widget that is used to portray this information is select boxes."),
  ...
  p("We wanted to explore the data set and what it had to offer in terms of comparison between the U.S. and Japan.
     ...
     of a variety of ages ranging from 15, to 75+. Additionally, we wanted to observe the differences
     in mental health within different genders in both countries. Some general questions we want answered are: How does the number of U.S. and Japan suicides compare overall? Does the U.S. have higher amounts of suicides? What can we tell from the data points
  ...
  h4("Info 201, Group Names"),
  p("Junna Cao, Bella Ge, Lauren Jensen, Tiffany Shields")
...
conclusion_page <- tabPanel(
  ...
  p("Lastly, in chart 3 we are able to directly compare the numbers of the U.S. and Japan directly for male and female suicides. In 2015,
  ...
  h3("Conclusion"),
  p("Overall, we are able to see that when comparing the U.S. and Japan directly, the U.S. has a higher amount of suicides
    when considering the data numerically. It is consistent that men have higher number of suicides in both countries than the data collected for females. With the charts
    listed in previous pages, we are able to see that the number of suicides seem to have an inverse relationship where one country's suicides decrease, the other's increase. Due to the limitations of our data,
    we are unable to pull any concrete conclusions as to why these numbers inverse other than inferring that there may have been events that took place during those years that may have affected
    the U.S. and Japan differently, which could affect the population's mental health and number of suicides."),
